...
// コンストラクタ
//==============================
CInputKeyboard::CInputKeyboard(void) : m_aKeyState(), m_aKeyStateTrigger()
{
...
// コンストラクタ
//==============================
CInputJoypad::CInputJoypad(void):m_state(), m_stateTrigger()
{
